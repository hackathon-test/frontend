...
function store_basic_data() {
  save_lecture_history({
    ...
    speaker: '陈振宇', expire: '2019-05-28T11:25'
  })
  ...
  save_lecture_history({
    ...
    , speaker: '陈振宇', expire: '2019-05-29T11:25'
  })
  ...
  save_lecture_history({
    id: gen_uuid(),
    title: '旧时月色和梅边消息',
    speaker: '陈振宇', expire: '2019-06-01T11:25'
  })

  save_lecture_history({
    id: gen_uuid(),
    title: '关于一种"中等"文学：兼论法国当代文学',
    speaker: '陈振宇', expire: '2019-05-31T11:25'
  })

  save_lecture_history({
    id: gen_uuid(),
    title: '国家治理现代化进程中的法治与德治思考',
    speaker: '陈振宇', expire: '2019-05-30T11:25'
  })
